...
export const brandReducer = (state = intialState, action) => {
  switch (action.type) {
    ...
    case types.GET_LIST_BRAND_NOT_PAG_SUCCESS:
      return {
        ...state,
    ...
    case types.GET_LIST_BRAND_NOT_PAG_FAIL:
      return {
        ...state,
        errorGetListNotPag: true,
        msgGetListNotPag: action.payload,
      };
    case types.GET_DETAIL_BRAND_SUCCESS:
      return {
        ...state,
    ...
    case types.GET_DETAIL_BRAND_FAIL:
      return {
        ...state,
        errorGetDetail: true,
